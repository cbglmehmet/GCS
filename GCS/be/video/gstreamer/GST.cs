...
namespace GCS.be.video
{
    public class GST
    {
        ...
        private static event EventHandler<System.Drawing.Bitmapp> _onNewImage;

        public static event EventHandler<System.Drawing.Bitmapp> onNewImage
        {
        ...
        public static class NativeMethods
        {
            ...
            public static void gst_version(out guint major, out guint minor, out guint micro, out guint nano)
            {
            ...
            public static void gst_buffer_extract_dup(IntPtr raw, UIntPtr offset, UIntPtr size, out IntPtr dest, out UIntPtr dest_size)
            {
            ...
            public static void gst_debug_bin_to_dot_file(IntPtr pipeline, GstDebugGraphDetails details, string file_name)
            {
                WinNativeMethods.gst_debug_bin_to_dot_file(pipeline, details, file_name);
            }
            public static IntPtr gst_app_sink_try_pull_sample(IntPtr appsink, GstClockTime timeout)
            {
            ...
            public static IntPtr gst_sample_get_caps(IntPtr sample)
            {
                return WinNativeMethods.gst_sample_get_caps(sample);
            }

            public static bool gst_structure_get_int(IntPtr structure, string fieldname, out int value)
            {
                return WinNativeMethods.gst_structure_get_int(structure, fieldname, out value);
            }


            public static IntPtr gst_caps_get_structure(IntPtr caps, guint index)
            {
            ...
            public static void gst_mini_object_unref(IntPtr mini_object)
            {
                ...
                try
                {
                    ...
                    if (sample != IntPtr.Zero)
                    {
                        ...
                        if (buffer != IntPtr.Zero)
                        {
                            ...
                            {
                                var image = new System.Drawing.Bitmapp(Width, Height, 4 * Width, (PixelFormat)SkiaSharp.SKColorType.Bgra8888,
                                    info.data);
        ...
        static GST()
        {
            ...
            var gstdir = @"C:\gstreamer\1.0\x86\bin\libgstreamer-1.0-0.dll";
            SetGSTPath(gstdir);
        }
        ...
        {
            get { return System.AppDomain.CurrentDomain.BaseDirectory + "\\libgstreamer-1.0-0.dll"; }
        }
        ...
        public static void LookForGstreamer()
        {
            string gstPath = @"C:\gstreamer\1.0\x86\bin\libgstreamer-1.0-0.dll";
            SetGSTPath(gstPath);
        }
        ...
        public static int readRTPData(Stream stream, MemoryStream ms)
        {
            ...
            if (ch1 == rtpbyte1)
            {
                ...
                if (ch2 == rtpbyte2 || ch2 == rtpbyte2_2)
                {
                    ...
                    GST.rtpheader header = new rtpheader(headerBytes);
                        ...
                        if (header.marker > 0 && width != 0)
                        {
                            ...
                            try
                            {
                                if (img == null || img.Width < width || img.Height < header.lineno + 1)
                                    img = new System.Drawing.Bitmapp(width, header.lineno + 1, (PixelFormat)SKColorType.Bgra8888);
        ...
        private static int readJPGData(Stream stream, MemoryStream ms)
        {
            ...
            if (ch3 == 0xff)
            {
                ...
                if (ch4 == 0xd8)
                {
                    ...
                    try
                    {
                        var temp = Bitmapp.FromStream(ms);
